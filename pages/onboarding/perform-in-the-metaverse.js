...
import { playAtTheMetaverseData as data } from "../../data/onboarding";
  ...
  return (
    <div>
      ...
      {!isMobile && (
        <section
          id="benefits"
          className="section-video align-items-center pt-5 d-none d-md-flex"
        >
      ...
      {isMobile && (
        <section
          id="benefits"
          className="section-video d-flex align-items-center d-flex d-md-none"
        >
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                  <div className="d-flex justify-content-end">
                    ...
                    {swiperIndex === 0 && !hasBeenSent && (
                      <SwiperButtonNext>Continue</SwiperButtonNext>
                    )}
                    {swiperIndex === 1 && !hasBeenSent && (
                      <input
                        className="btn btn-lg btn-light mt-3 rounded-pill"
                        style={{ marginLeft: 5 }}
                        type="submit"
                      />
                    )}
