          ...
          <div className='col-12 col-md-4 offset-md-6 text-left'>
            <div className='row'>
              <div className='d-none d-md-block col-6 pt-5 pt-md-0'>
                <p className='mb-0'><a href="https://www.instagram.com/thebeatblox/" className='mb-1'>Instagram</a></p>
                <p className='mb-0'><a href="https://discord.gg/GcQjuUvwbm" className='mb-1'>Discord</a></p>
                <p className='mb-0'><a href="https://twitter.com/The_Beatblox" className='mb-1'>Twitter</a></p>
                <p className='mb-0'><a href="https://linkedin.com/company/beatblox" className='mb-1'>Linkedin</a></p>
                <p className='mb-0'><a href="https://youtube.com/thebeatblox" className='mb-1'>YouTube</a></p>
              </div>
