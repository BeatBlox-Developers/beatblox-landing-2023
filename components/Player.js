...
const Player = () => {
  ...
  return (
    <>
      <section
        id="player"
        className="full-height section-video py-5 d-flex align-items-center"
      >
        <video
          autoPlay={true}
          controls={false}
              ...
              <div className="row">
                <div className="col text-black">
                  <AnimationOnScroll animateIn="animate__fadeInUp">
                    <h1 className="pt-3">
                      Listen <span className="font-family-sans">&</span>
                      <br />
                      Take Part
                    </h1>
                    <h4 className="pt-3">
          ...
          <div className="row my-5 ">
            <div className="col-6 mx-auto">
              <button
                ...
                onClick={() => window.open("https://beatblox.market/#explore")}
              >
                Discover More
              </button>
            </div>
