        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto my-2 my-lg-0">
              <Nav.Link href="#"><u>FAQs</u></Nav.Link>
              ...
              <Row>
                <Col sm={3}>
                  ...
                  <Nav variant="pills" className="flex-column">
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="faq-2">What is BeatBlox Early Supporter NFT?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-3">How do I see my Early Supporter NFT?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-4">Is the Early Supporter NFT a BeatBlox’s Auction House Music NFT?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-5">What are gas, gwei or network fees?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-6">What happens to gas fees?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-7">What is a Blockchain?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-8">What is an NFT?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-9">What is cryptocurrency?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-10">What is a “digital wallet”?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-11">What is Ethereum?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-12">What is Polygon (previously known as MATIC)?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-13">What blockchain are these NFTs minted on?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-14">How do I purchase MATIC (Polygon)?</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="faq-15">What is an NFT marketplace?</Nav.Link>
                    </Nav.Item>
                  </Nav>
                </Col>
                <Col sm={8}>
                  <Tab.Content>
                    ...
                    <Tab.Pane eventKey="faq-2">
                      <h3 className="mb-3">What is BeatBlox Early Supporter NFT?</h3>
                      <p>
                        We are minting a special NFT that will be available for 10 MATIC and will grant early supporters the following benefits:
                        <br/><br/>
                        Early access to Closed Beta Auction House.<br/>
                        BeatBlox Collectible Credential Artwork.<br/>
                        BeatBlox Wearable for Decentraland.<br/>
                        BeatBlox Genesis Tokenized Track.<br/>
                        Voting power for future governance system over platform catalog and activities.<br/>
                        BeatBlox Airdrops.<br/>
                        Membership for BeatBlox Decentraland District Mountain Club.<br/>
                        Access to early supporters only virtual events and meet & greets.<br/>
                        Preferential access to future BeatBlox products.<br/>
                        1 out of 1000 will randomly receive an extremely rare Credential.<br/>
                        Decentraland District Games and Installations credits.<br/>
                        Token compatible with every major marketplace for secondary sales, no commission added
                      </p>
                    </Tab.Pane>
                    <Tab.Pane eventKey="faq-3">
                      <h3 className="mb-3">How do I see my Early Supporter NFT?</h3>
                      <p>
                    ...
                    <Tab.Pane eventKey="faq-4">
                      <h3 className="mb-3">Is the Early Supporter NFT a BeatBlox’s Auction House Music NFT?</h3>
                      <p>
                    ...
                    <Tab.Pane eventKey="faq-5">
                      <h3 className="mb-3">What are gas, gwei or network fees?</h3>
                      <p>
                    ...
                    <Tab.Pane eventKey="faq-7">
                      ...
                      <p>
                        A blockchain is a decentralized, distributed, and oftentimes public, digital ledger consisting of records called blocks that is used to record transactions across many computers so that any involved block cannot be altered retroactively, without the alteration of all subsequent blocks.<br/><br/>
                    ...
                    <Tab.Pane eventKey="faq-12">
                      <h3 className="mb-3">What is Polygon (previously known as MATIC)?</h3>
                      <p>
                        ...
                        <br/><br/>
                        You can check MATIC token price compared to USD on the following link:
                        <a href="https://www.coingecko.com/es/monedas/polygon" target="_blank" rel="noreferrer">https://www.coingecko.com/es/monedas/polygon</a>
                      </p>
                    </Tab.Pane>
                    <Tab.Pane eventKey="faq-13">
                      <h3 className="mb-3">What blockchain are these NFTs minted on?</h3>
                      <p>
                    ...
                    <Tab.Pane eventKey="faq-14">
                      <h3 className="mb-3">How do I purchase MATIC (Polygon)?</h3>
                      <p>
                        ...
                        <br/><br/>
                        You can purchase MATIC through an online exchange such as:
                        <a href="https://www.binance.com" target="_blank" rel="noreferrer">https://www.binance.com</a> or
                        <a href="https://ftx.com" target="_blank" rel="noreferrer">https://ftx.com</a> 
                        Once you have purchased MATIC, you can transfer the funds into your Metamask or another compatible wallet to purchase an NFT. 
                        <br/><br/>
